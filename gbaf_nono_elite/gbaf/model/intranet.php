...
{
    require('db/connexion.php');
    $req = $db->prepare('INSERT INTO gbaf_comment(comment, date_add, gbaf_actor_id, gbaf_member_id) VALUES(:comment, NOW(), :gbaf_actor_id, :gbaf_member_id)');
    $req->execute(array(
        'comment' => $comment,
        'gbaf_actor_id' => $idActor,
        'gbaf_member_id' => $idMember
    ));
}
...
{
    require('db/connexion.php');
    $req = $db->prepare('INSERT INTO gbaf_vote(vote, gbaf_actor_id, gbaf_member_id) VALUES(:vote, :gbaf_actor_id, :gbaf_member_id)');
    $req->execute(array(
        'vote' => $vote,
        'gbaf_actor_id' => $idActor,
        'gbaf_member_id' => $idMember
